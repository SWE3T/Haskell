...
happyExpList = Happy_Data_Array.listArray (0,196) ([480,2116,8,0,0,0,4088,16,0,0,0,0,0,256,0,480,2116,16,0,32768,0,4088,18,8192,0,512,7680,33856,1920,8464,480,2116,120,529,16414,32900,4103,57377,17409,30728,4352,7682,33856,256,0,0,0,0,0,0,0,0,0,128,0,48,0,14,49152,3,0,0,0,0,16414,132,0,0,0,30721,4352,57346,16447,1921,8464,65024,1043,16,0,16352,32864,4103,33,248,30720,4352,2,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser","Exp","RecordList","num","var","true","false","equal","different","'+'","'-'","'*'","'&'","'|'","'>'","'<'","'{'","'='","','","'}'","'('","')'","'?'","':'","'.'","let","in","%eof"]
        bit_start = st * 30
        bit_end = (st + 1) * 30
...
action_3 (27) = happyShift action_23
...
action_10 (20) = happyShift action_37
...
action_11 (24) = happyShift action_36
...
action_13 (20) = happyShift action_34
...
action_23 (7) = happyShift action_24
...
action_34 (4) = happyGoto action_40
...
action_41 (7) = happyShift action_13
...
happyReduction_17 (HappyTerminal (TokenVar happy_var_3))
	...
	(HappyAbsSyn4  happy_var_1)
	 =  HappyAbsSyn4
		 (AcessRecord happy_var_1 happy_var_3
	)
...
happyReduction_18 ((HappyAbsSyn4  happy_var_7) `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn4
		 (Ternary happy_var_2 happy_var_5 happy_var_7
	) `HappyStk` happyRest
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenSmaller -> cont 18;
	TokenLBracket -> cont 19;
	TokenAssign -> cont 20;
	TokenComma -> cont 21;
	TokenRBracket -> cont 22;
	TokenLParen -> cont 23;
	TokenRParen -> cont 24;
	TokenQMark -> cont 25;
	TokenDDots -> cont 26;
