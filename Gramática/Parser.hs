...
happyExpList = Happy_Data_Array.listArray (0,63) ([8672,514,0,0,480,0,0,0,0,4,64,0,4,256,1024,8672,7682,57378,545,8734,0,0,0,0,64,8672,2,57344,545,16864,40448,1024,57344,545,0,0,0,0
	])
